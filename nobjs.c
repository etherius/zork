...
static logical mirpan_ P((int, logical));
...
/* 						!WAS CANARY INSIDE? */
    PrintMessage(objcts_1.odesco[oindex_1.bcana - 1]);
/* 						!YES, DESCRIBE RESULT. */
...
/* 						!DROP OBJ. */
    PrintTwoMessages(760, objcts_1.odesc2[i - 1]);
    return ret_val;
